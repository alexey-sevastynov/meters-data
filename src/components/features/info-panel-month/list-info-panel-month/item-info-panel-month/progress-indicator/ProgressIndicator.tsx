...
import {
  ...
  calculateWidth,
} from "./progressIndicator.function";
...
export function ProgressIndicator({
  ...
  return (
    <span
      className={
        isMinus ? Style.progressIndicator__left : Style.progressIndicator__right
      }
    >
      <motion.span
        className={
          isMinus
            ? Style.progressIndicator__left_minus
            : Style.progressIndicator__right_plus
        }
        initial={{ width: 0 }}
